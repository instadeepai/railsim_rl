...
class RailsimConnecterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getAction = channel.unary_unary(
                ...
                request_serializer=railsim__pb2.ProtoGetActionRequest.SerializeToString,
...
def add_RailsimConnecterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getAction': grpc.unary_unary_rpc_method_handler(
                    servicer.getAction,
                    request_deserializer=railsim__pb2.ProtoGetActionRequest.FromString,
...
class RailsimConnecter(object):
    ...
    def getAction(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/RailsimConnecter/getAction',
            railsim__pb2.ProtoGetActionRequest.SerializeToString,
...
class RailsimFactoryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getAgentIds = channel.unary_unary(
                '/RailsimFactory/getAgentIds',
                request_serializer=railsim__pb2.ProtoGrpcPort.SerializeToString,
                response_deserializer=railsim__pb2.ProtoAgentIDs.FromString,
                )
...
class RailsimFactoryServicer(object):
    ...
    def getAgentIds(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RailsimFactoryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getAgentIds': grpc.unary_unary_rpc_method_handler(
                    servicer.getAgentIds,
                    request_deserializer=railsim__pb2.ProtoGrpcPort.FromString,
                    response_serializer=railsim__pb2.ProtoAgentIDs.SerializeToString,
            ),
    }
...
class RailsimFactory(object):
    ...
    def getAgentIds(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/RailsimFactory/getAgentIds',
            railsim__pb2.ProtoGrpcPort.SerializeToString,
            railsim__pb2.ProtoAgentIDs.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
